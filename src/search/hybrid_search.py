...
class CodeSearchIndex:
    ...
    def index_documents_batch(self, documents: list[dict], batch_size: int = 100) -> None:
        """
    ...
    def hybrid_search(
        ...
        search_params = {
            ...
            "top": top_k,
            "select": [
                "id", "content", "language", "file_path", "repo_name",
                "chunk_type", "tables_referenced", "columns_referenced",
                "start_line", "end_line"
            ],
    ...
    def get_lineage_context(
        ...
        for r in results:
            ...
            if (source_table.lower() in [t.lower() for t in refs] and 
                target_table.lower() in [t.lower() for t in refs]):
                filtered.append(r)
