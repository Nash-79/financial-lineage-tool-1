...
- [Implementation Summary](../openspec/changes/optimize-ingestion-pipeline/IMPLEMENTATION_SUMMARY.md)
- [Performance Optimization Proposal](../openspec/changes/optimize-ingestion-pipeline/DESIGN.md)
