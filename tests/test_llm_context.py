...
class TestLLMContextInjection(unittest.TestCase):
    ...
    def test_ingest_with_context(self):
        ...
        self.assertTrue(data.get("context_applied"), "Context should be applied when project_id is provided and context exists")
    ...
    def test_ingest_without_context(self):
        ...
        self.assertFalse(data.get("context_applied"), "Context should NOT be applied when project_id is missing")
